    ...
    <div class="crm-container">
      ...
      <el-table
        ...
        <el-table-column
          ...
          width="100">
          <template slot-scope="scope">
            <el-button type="text" @click="handleClick(scope.row, scope.$index)">{{ getRowButtonName(scope.row) }}</el-button>
          </template>
        </el-table-column>
      </el-table>
...
export default {
  ...
  created() {
    window.onresize = () => {
      this.tableHeight = document.documentElement.clientHeight - (this.subTabShow ? 235 : 195)
    }
