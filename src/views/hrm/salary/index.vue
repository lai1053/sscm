  ...
  <div id="employee-main-container" class="salary-index">
    <template v-if="listShow">
      <reminder
        ...
        <el-button style="margin-left: 8px;" type="text" @click="checkNoEmployeesClick">查看无薪资组员工</el-button>
      </reminder>
      <xr-header
...
export default {
  ...
  computed: {
    ...
    createShow() {
      ...
      if (this.examineData && this.lastData) {
        return this.lastData.checkStatus == 1
      }
      return true
    }
  },
  ...
  methods: {
     ...
     */
    getTableHeight() {
      this.tableHeight = document.documentElement.clientHeight - (this.tabShow ? 235 : 185) - (this.noNum > 0 ? 40 : 0)
    },
