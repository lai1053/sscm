 ...
 * @LastEditTime: 2020-06-30 10:41:06
 * @LastEditors: yang
-->
<template>
  <xr-create
    ...
    if (this.detail) {
      ...
      this.baseFields.forEach(item => {
        if (item.formType == 'salary') {
          ...
          baseForm.interviewEmployeeIds = this.detail.interviewEmployeeIds ? this.detail.interviewEmployeeIds.split(',').map(item => parseInt(item)) : []
