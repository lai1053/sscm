    ...
    <div class="form-add-dialog-body">
      <el-form ref="schemeForm" :model="form" label-position="top" label-width="80px">
        ...
        <template v-if="schemeType == 1">
          <div style="font-weight: bold;margin-bottom: 8px;">编辑社保各项基数</div>
          <flexbox wrap="wrap">
            <el-form-item
          ...
          <template v-if="form.providentFundList && form.providentFundList.length > 0">
            <div style="font-weight: bold;margin-bottom: 8px;">编辑公积金各项基数</div>
            <flexbox wrap="wrap">
              <el-form-item
        ...
        <template v-if="schemeType == 2">
          <div style="font-weight: bold;margin-bottom: 8px;">编辑社保金额</div>
          <flexbox
            v-for="(item, index) in form.socialSecurityList"
            :key="`s${index}`"
            wrap="wrap">
          ...
          <div style="font-weight: bold;margin-bottom: 8px;">编辑公积金金额</div>
          <flexbox
            v-for="(item, index) in form.providentFundList"
            :key="`p${index}`"
            wrap="wrap">
