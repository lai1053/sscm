      ...
      >
        <div
          ...
          <el-button
            ...
            icon="el-icon-plus" type="text" @click="bigAddClick(form.noFixedSegList)">添加考核项</el-button>
        </div>
        <div
          class="section">
          <div class="section__title">
          ...
          <el-button
            icon="el-icon-plus" type="text" @click="bigAddClick(form.fixedSegList)">添加考核项</el-button>
        </div>
