...
::v-deep.map-info--name {
  ...
  ::v-deep .map-window--img {
    width: 12px;
    height: 12px;
    margin-right: 8px;
  }
  ::v-deep .map-window--content{
     font-size: 12px;
