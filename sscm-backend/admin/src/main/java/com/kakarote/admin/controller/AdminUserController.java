...
import com.kakarote.admin.oceanengine.model.OeLoginSaleInfoVO;
...
public class AdminUserController {
    ...
    @Autowired
    private OeIdentityService oeIdentityService;
    ...
    public Result<AdminUserVO> queryLoginUser(HttpServletRequest request, HttpServletResponse response) {
        ...
        adminUser.setOceanengineSale(buildOeLoginSaleInfo(adminUser.getUserId(), adminUser.getRealname()));
    ...
    private OeLoginSaleInfoVO buildOeLoginSaleInfo(Long crmUserId, String crmRealname) {
        if (crmUserId == null) {
            return null;
        }
        Long saleId = oeIdentityService.getOeSaleUserIdByAdminUserId(crmUserId);
        OeLoginSaleInfoVO vo = new OeLoginSaleInfoVO();
        vo.setSaleUserId(crmUserId);
        vo.setCrmUserId(crmUserId);
        vo.setSaleName(crmRealname);
        vo.setCrmRealname(crmRealname);
        vo.setSaleId(saleId);
        return vo;
    }
